...
TEST_CASE("monitor_object_collection_merge_cycle")
{
  ...
  targetMoTH1I->setIsOwner(true);
  target.Add(targetMoTH1I);
  targetMoTH1I->addOrUpdateMetadata(repository::metadata_keys::cycle, "1");
  ...
  otherMoTH1I->setIsOwner(true);
  other.Add(otherMoTH1I);
  otherMoTH1I->addOrUpdateMetadata(repository::metadata_keys::cycle, "2");

  algorithm::merge(&target, &other);

  const auto mergedCycle = targetMoTH1I->getMetadata(repository::metadata_keys::cycle);
